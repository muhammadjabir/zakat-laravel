...
@section('judul')
Halaman Edit Data Pembagian Zakat 
@endsection
@section('activepage','Pembagian')
@section('pg-header')
<i class="ace-icon fa fa-leaf leaf-icon"></i> &nbsp; Edit Data Pembagian Zakat 
@endsection

@section('pg-text')
Ini Adalah Halaman Edit Data Pembagian Zakat
@endsection

@section('content')
		<a href="{{ route('mustahik.show',['id'=>$pembagian->mustahik->id]) }}" class="btn btn-sm btn-light"><i class="fa fa-angle-double-left"></i>&nbsp; Kembali ke halaman Sebelumnya</a>
...
<div class="col-xs-12 col-sm-3 center">
				<span class="profile-picture">
					...
					@if($pembagian->mustahik->foto != null)
					{{asset('public/storage/'.$pembagian->mustahik->foto)}}
				...
				<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
					<div class="inline position-relative">
							<span class="white">{{$pembagian->mustahik->nama_mustahik}}</span>													
					</div>
				</div>
</div><!-- ini foto -->
<div class="col-md-9">
...
<div class="col-xs-12 col-sm-9">
	...
	<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title">Edit Data Pembagian Zakat</h4>
						</div>
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<form class="form-horizontal" role="form" action="{{route('pembagian.update',['id'=>$pembagian->id])}}" method="POST">
									@csrf
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="nama" id="nama" value="{{$pembagian->mustahik->nama_mustahik}}" placeholder="Nama mustahik" class="col-xs-10 col-sm-12" disabled />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="tipe" id="tipe" value="{{$pembagian->tipemustahiks->tipe_mustahik}}" placeholder="Tipe Mustahik" class="col-xs-10 col-sm-12" disabled />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="alamat" id="alamat" placeholder="Alamat" class="col-xs-10 col-sm-12" disabled>{{$pembagian->mustahik->alamat}}</textarea>
										</div>
									</div>
									...
									<div class="form-group {{$errors->has('beras') ? 'has-error' : '' }}">
										...
										<div class="col-sm-4">
											...
											<input type="text" onkeypress="return isNumberKey(event,this)" name="beras" id="total" value="{{$pembagian->beras}}" placeholder="Satuan Kg Contoh : 1.5 / 2" class="col-xs-10 col-sm-12" />
											@if($errors->has('beras'))
										...
										<div class="form-group {{$errors->has('uang') ? 'has-error' : '' }}">
											...
											<div class="col-sm-4">
											<input type="text" name="uang" onkeypress="return hanyaAngka(event)" id="keluar" value="{{$pembagian->uang}}" placeholder="Jumlah Uang Yang Diberikan" class="col-xs-10 col-sm-12" />
											@if($errors->has('uang'))
